...
Write-Error "DEBUGPRINT[1]: profile.ps1:126: $current_theme_file=$$current_theme_file"
Write-Error "DEBUGPRINT[2]: profile.ps1:128: $env:THEME=$$env:THEME"
...
$palette = @{
    cmdline = @{
        ...
        selection = $catppuccin.Surface0 # FIX: use visual from nvim
