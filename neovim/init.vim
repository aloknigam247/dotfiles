...
function ColoRand()
    local colos = {
        ...
        { 'base2tone_cave_light',       'light', '_' },
        { 'base2tone_desert_dark',      'dark',  '_' },
        { 'base2tone_desert_light',     'light', '_' },
        { 'base2tone_drawbridge_dark',  'dark',  '_' },
        { 'base2tone_drawbridge_light', 'light', '_' },
        { 'base2tone_earth_dark',       'dark',  '_' },
        { 'base2tone_earth_light',      'light', '_' },
        { 'base2tone_evening_dark',     'dark',  '_' },
        { 'base2tone_evening_light',    'light', '_' },
        { 'base2tone_field_dark',       'dark',  '_' },
        { 'base2tone_field_light',      'light', '_' },
        { 'base2tone_forest_dark',      'dark',  '_' },
        { 'base2tone_forest_light',     'light', '_' },
        { 'base2tone_garden_dark',      'dark',  '_' },
        { 'base2tone_garden_light',     'light', '_' },
        { 'base2tone_heath_dark',       'dark',  '_' },
        { 'base2tone_heath_light',      'light', '_' },
        { 'base2tone_lake_dark',        'dark',  '_' },
        { 'base2tone_lake_light',       'light', '_' },
        { 'base2tone_lavender_dark',    'dark',  '_' },
        { 'base2tone_lavender_light',   'light', '_' },
        { 'base2tone_mall_dark',        'dark',  '_' },
        { 'base2tone_mall_light',       'light', '_' },
        { 'base2tone_meadow_dark',      'dark',  '_' },
        { 'base2tone_meadow_light',     'light', '_' },
        { 'base2tone_morning_dark',     'dark',  '_' },
        { 'base2tone_morning_light',    'light', '_' },
        { 'base2tone_motel_light',      'light', '_' },
        { 'base2tone_pool_dark',        'dark',  '_' },
        { 'base2tone_pool_light',       'light', '_' },
        { 'base2tone_porch_dark',       'dark',  '_' },
        { 'base2tone_porch_light',      'light', '_' },
        { 'base2tone_sea_dark',         'dark',  '_' },
        { 'base2tone_sea_light',        'light', '_' },
        { 'base2tone_space_dark',       'dark',  '_' },
        { 'base2tone_space_light',      'light', '_' },
        { 'base2tone_suburb_dark',      'dark',  '_' },
        { 'base2tone_suburb_light',     'light', '_' },
        { 'blue',                       'dark',  '_' },
        { 'calvera',                    'dark',  '_' },
        { 'carbonfox',                  'dark',  '_' },
